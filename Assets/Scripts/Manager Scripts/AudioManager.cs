...
public class AudioManager : MonoBehaviour
{
    ...
    public AudioSource PlayAudio(AudioClip clip, Transform location, float volume, float pitch, GameObject parentObj, bool loop)
    {
        //make the empty game object
        GameObject createdAudio = new GameObject("Audio: " + clip.name);
        createdAudio.transform.position = location.position;
        createdAudio.transform.parent = parentObj.transform;
